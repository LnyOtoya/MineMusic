 ...
 *
 */
package com.example.minemusic.appwidgets.base
...
import com.example.minemusic.service.MusicService.Companion.META_CHANGED
import com.example.minemusic.service.MusicService.Companion.PLAY_STATE_CHANGED
...
abstract class BaseAppWidget : AppWidgetProvider() {
    ...
    protected fun getAlbumArtDrawable(context: Context, bitmap: Bitmap?): Drawable {
        return if (bitmap == null) {
            ContextCompat.getDrawable(context, R.mipmap.launcher_icon)!!
        } else {
