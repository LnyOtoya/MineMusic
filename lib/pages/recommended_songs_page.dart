...
class _RecommendedSongsPageState extends State<RecommendedSongsPage> {
  ...
  static const String _cacheKeyDate = 'recommended_songs_date';
  static const String _cacheKeySongs = 'recommended_songs_data';
  ...
  Future<void> _loadSongs() async {
    ...
    if (cachedDate == today && cachedSongsJson != null) {
      ...
      _songsFuture = widget.api.getRandomSongs(count: 20);
  ...
  Future<void> _cacheSongs(List<Map<String, dynamic>> songs, String date) async {
    final prefs = await SharedPreferences.getInstance();
